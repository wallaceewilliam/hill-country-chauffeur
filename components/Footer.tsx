...
export default function Footer() { return <footer className="bg-charcoal text-cream">
  <div className="site-shell grid gap-12 py-16 md:grid-cols-[1.3fr_1fr_1fr]">
    ...
    <div><h3 className="footer-heading">Connect</h3><div className="footer-links"><a href="tel:+15125550184"><Phone size={15}/> (512) 555-0184</a><a href="mailto:hello@hillcountrychauffeur.com"><Mail size={15}/> hello@hillcountrychauffeur.com</a><a href="#" aria-label="Instagram"><Camera size={16}/> Instagram</a></div></div>
